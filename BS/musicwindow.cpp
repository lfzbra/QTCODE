...
void MusicWindow::btn_play_clicked()
{
...
void MusicWindow::btn_next_clicked()
{
    musicPlayer->stop();
...
void MusicWindow::btn_previous_clicked()
{
    musicPlayer->stop();
    int count = mediaPlaylist->mediaCount();
    if (0 == count)
...
void MusicWindow::mediaPlayerStateChanged(
        QMediaPlayer::State
        state)
{
    switch (state) {
...
void MusicWindow::listWidgetCliked(QListWidgetItem *item)
{
    musicPlayer->stop();
...
void MusicWindow::mediaPlaylistCurrentIndexChanged(
        int index)
{
    if (-1 == index)
        return;
...
void MusicWindow::musicPlayerDurationChanged(
        qint64 duration)
{
...
void MusicWindow::mediaPlayerPositionChanged(
        qint64 position)
{
...
void MusicWindow::durationSliderReleased()
{
    /* 设置媒体播放的位置 */
...
void MusicWindow::mediaPlayerInit()
{
